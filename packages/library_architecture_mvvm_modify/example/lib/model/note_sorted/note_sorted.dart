...
class NoteSorted extends BaseModel {
  ...
  NoteSorted.success(this.enumNoteSorted, this.isEmptyListNote)
      : super.success("");
  NoteSorted.exception(super.exception) : super.exception();

  static NoteSorted get getNoteSortedForSuccess =>
      NoteSorted.success(EnumNoteSorted.all, false);
  @visibleForTesting
  static NoteSorted get getNoteSortedForSuccessWhereUnitTest =>
      NoteSorted.success(EnumNoteSorted.all, false);

  EnumNoteSortedForNotesOverviewFilterButtonWidget
      get getEnumNoteSortedForNotesOverviewFilterButtonWidget {
  ...
  set setOneParametersNamedForNotesOverviewFilterButtonWidget(
      EnumNoteSorted enumNoteSorted) {
