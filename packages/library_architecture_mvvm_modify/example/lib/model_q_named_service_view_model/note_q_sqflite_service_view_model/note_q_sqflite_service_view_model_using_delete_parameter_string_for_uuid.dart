...
base class NoteQSqfliteServiceViewModelUsingDeleteParameterStringForUuId<
        T extends Note,
  ...
  Future<Result<int>?> deleteNoteToSqfliteServiceParameterString(
      String parameter) {
    return super
        .deleteModelToNamedServiceParameterNamed<int, String>(parameter);
  }
  ...
  @protected
  @override
  Future<Result<int>?> deleteModelToNamedServiceParameterNamedDS(
      String? parameter) async {
    try {
      final database = await sqfliteService.getDatabase;
      final result = await database?.delete(SqfliteService.constTableNote,
