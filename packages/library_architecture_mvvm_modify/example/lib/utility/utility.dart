...
ScaffoldMessengerState scaffoldMessengerStateForDeletedNote(
    BuildContext context, Note note, Function(Note insertNote) onPressed) {
...
ScaffoldFeatureController scaffoldFeatureControllerForException(
