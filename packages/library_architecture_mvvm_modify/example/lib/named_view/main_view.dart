        ...
        child: Row(
          ...
          children: [
            IconButton(
              onPressed: () {
                setState(() {
                  _lo.getMainTab?.setEnumMainTabNameTodosParameterEnumMainTab();
                });
              },
              iconSize: 32,
              color: _lo.getMainTab!
                      .isEqualsEnumMainTabNameTodosParameterEnumMainTab()!
            ...
            IconButton(
              onPressed: () {
                setState(() {
                  _lo.getMainTab?.setEnumMainTabNameStatsParameterEnumMainTab();
                });
              },
              iconSize: 32,
              color: _lo.getMainTab!
                      .isEqualsEnumMainTabNameStatsParameterEnumMainTab()!
                  ? Theme.of(context).colorScheme.secondary
                  : null,
