...
class NotesOverviewFilterButtonWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<NoteSorted?>(
        ...
        builder:
            (BuildContext context, AsyncSnapshot<NoteSorted?> asyncSnapshot) {
  ...
  Widget buildSuccess(BuildContext context, NoteSorted? noteSorted) {
    ...
    return PopupMenuButton<EnumNoteSorted>(
      ...
      initialValue:
          noteSorted?.getOneParametersNamedForNotesOverviewFilterButtonWidget,
      tooltip: l10n.todosOverviewFilterTooltip,
      onSelected: (EnumNoteSorted filter) {
        lo.setOneParametersNamedForNotesOverviewFilterButtonWidgetByNoteSortedAndInGeneralZeroTask(
            filter);
      },
      itemBuilder: (context) {
        return [
