...
base class NotesOverviewOptionsButtonWidget extends StatelessWidget {
  @protected
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<NoteOption?>(
        ...
        builder:
            (BuildContext context, AsyncSnapshot<NoteOption?> asyncSnapshot) {
  ...
  Widget buildSuccess(BuildContext context, NoteOption? noteOption) {
    ...
    return PopupMenuButton<EnumNoteOption>(
      ...
      onSelected: (EnumNoteOption option) {
        lo.callMethodUpdateListNoteToSqfliteServiceParameterBoolAndInGeneralOneTask(
            option);
      },
      itemBuilder: (context) {
        return [
