...
final class EditNoteViewListViewModel extends BaseNamedViewListViewModel {
  ...
  late final NoteDeleteIconButtonWidgetListViewModel
  ...
  EditNoteViewListViewModel() {
    ...
    descriptionTextFormFieldWidgetListViewModel =
        DescriptionTextFormFieldWidgetListViewModel(
            _stringsQThereIsStateViewModelForDescription);
    noteDeleteIconButtonWidgetListViewModel =
        NoteDeleteIconButtonWidgetListViewModel(_noteQThereIsStateViewModel,
  ...
  Future<void> setNoteByNoteAndInGeneralZeroTask(Note note) async {
    _noteQThereIsStateViewModel.setNote = note;
    _stringsQThereIsStateViewModelForTitle.getStrings?.field = note.name ?? "";
    _stringsQThereIsStateViewModelForDescription.getStrings?.field =
        note.description ?? "";
