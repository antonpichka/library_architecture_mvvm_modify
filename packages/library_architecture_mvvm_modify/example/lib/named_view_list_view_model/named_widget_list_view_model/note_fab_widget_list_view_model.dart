...
class NoteFabWidgetListViewModel {
  ...
  Future<void>
      insertNoteToSqfliteServiceParameterNoteUsingFBDSAndInGeneralOneTask(
    ...
    final result = await noteQSqfliteServiceViewModelUsingInsertParameterNote
        .insertNoteToSqfliteServiceParameterNoteUsingFBDS(
            getNoteForInsertNoteToSqfliteServiceParameterNoteUsingFBDSAndInGeneralOneTask());
  ...
  Note
      getNoteForInsertNoteToSqfliteServiceParameterNoteUsingFBDSAndInGeneralOneTask() {
    return Note.success(stringsQThereIsStateViewModelForTitle.getStrings?.field,
        stringsQThereIsStateViewModelForDescription.getStrings?.field, false);
  }
}
