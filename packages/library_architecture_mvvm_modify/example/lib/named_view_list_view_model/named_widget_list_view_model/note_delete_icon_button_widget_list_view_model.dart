...
base class NoteDeleteIconButtonWidgetListViewModel {
  @protected
  ...
  NoteDeleteIconButtonWidgetListViewModel(this.noteQThereIsStateViewModel,
    ...
    final result =
        await noteQSqfliteServiceViewModelUsingDeleteParameterStringForUuId
            .deleteNoteToSqfliteServiceParameterString(
                getStrForDeleteNoteToSqfliteServiceParameterStringAndInGeneralOneTask());
