...
base class DescriptionTextFormFieldWidgetListViewModel {
  @protected
  ...
  void setFieldByStringsAndInGeneralZeroTask(String value) {
    stringsQThereIsStateViewModelForDescription.getStrings?.field = value;
    stringsQThereIsStateViewModelForDescription.notifyStreamStrings();
  }
}
