...
abstract interface class IInitializedStreamStateDataForNamedWidgetOrView<T extends BaseDataForNamedWidgetOrView> {
  // Default class: return DefaultStreamStateDataForNamedWidgetOrView<DataForAccountWidget>(DataForAccountWidget.success());
  IStreamStateDataForNamedWidgetOrView<T> get getStreamStateDataForNamedWidgetOrView;
}
