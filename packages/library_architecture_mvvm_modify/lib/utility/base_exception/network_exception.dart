...
final class NetworkException extends BaseException {
  ...
  factory NetworkException.fromKeyAndStatusCode(
    ...
    switch (statusCode) {
      ...
      case 202:
        return NetworkException(thisClass, key, 202, '202 Accepted',
      ...
      case 204:
        return NetworkException(thisClass, key, 204, '204 No Content',
            'The server has fulfilled the request but does not need to return an entity-body, and might want to return updated metaInformation.');
      case 205:
        return NetworkException(thisClass, key, 205, '205 Reset Content',
            'The server has fulfilled the request and the user agent SHOULD reset the document view which caused the request to be sent.');
      case 206:
        return NetworkException(thisClass, key, 206, '206 Partial Content',
      ...
      case 304:
        return NetworkException(thisClass, key, 304, '304 Not Modified',
            'If the client has performed a conditional GET request and access is allowed, but the document has not been modified, the server SHOULD respond with this status code.');
      case 305:
        return NetworkException(thisClass, key, 305, '305 Use Proxy',
            'The requested resource MUST be accessed through the proxy given by the Location field.');
      case 307:
        return NetworkException(thisClass, key, 307, '307 Temporary Redirect',
            'The requested resource resides temporarily under a different URI.');
      case 400:
        return NetworkException(thisClass, key, 400, '400 Bad Request',
            'The request could not be understood by the server due to malformed syntax.');
      case 401:
        return NetworkException(thisClass, key, 401, '401 Unauthorized',
            'The request requires user authentication.');
      case 403:
        return NetworkException(thisClass, key, 403, '403 Forbidden',
            'The server understood the request, but is refusing to fulfill it.');
      case 404:
        return NetworkException(thisClass, key, 404, '404 Not Found',
            'The server has not found anything matching the Request-URI.');
      case 405:
        return NetworkException(thisClass, key, 405, '405 Method Not Allowed',
            'The method specified in the Request-Line is not allowed for the resource identified by the Request-URI.');
      case 406:
        return NetworkException(thisClass, key, 406, '406 Not Acceptable',
      ...
      case 408:
        return NetworkException(thisClass, key, 408, '408 Request Timeout',
            'The client did not produce a request within the time that the server was prepared to wait.');
      case 409:
        return NetworkException(thisClass, key, 409, '409 Conflict',
            'The request could not be completed due to a conflict with the current state of the resource.');
      case 410:
        return NetworkException(thisClass, key, 410, '410 Gone',
            'The requested resource is no longer available at the server and no forwarding address is known.');
      case 411:
        return NetworkException(thisClass, key, 411, '411 Length Required',
      ...
      case 502:
        return NetworkException(thisClass, key, 502, '502 Bad Gateway',
            'The server, while acting as a gateway or proxy, received an invalid response from the upstream server it accessed in attempting to fulfill the request.');
      case 503:
        return NetworkException(thisClass, key, 503, '503 Service Unavailable',
            'The server is currently unable to handle the request due to a temporary overloading or maintenance of the server.');
      case 504:
        return NetworkException(thisClass, key, 504, '504 Gateway Timeout',
