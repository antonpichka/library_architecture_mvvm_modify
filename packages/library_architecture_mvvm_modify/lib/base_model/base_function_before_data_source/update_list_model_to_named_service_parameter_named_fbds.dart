...
/// An example of a class name in a real project: UpdateListMovieToSqfliteServiceParameterListMovieFBDSUsingUpdateListParameterListMovie
/// ParameterListMovie - with a parameter for update list
...
abstract class UpdateListModelToNamedServiceParameterNamedFBDS<Z extends Object,X extends Object,C extends Object> {
  Result<Z>? updateListModelToNamedServiceParameterNamed(
      X? parameter,
      C? parameterForFBDS);
}