...
/// An example of a class name in a real project: DeleteListMovieToSqfliteServiceNPFBDSUsingDeleteListNP
/// NP - no parameter
...
abstract base class DeleteListModelToNamedServiceNPFBDS<X extends Object,
    C extends Object> {
  Result<X>? deleteListModelToNamedServiceNP(C? parameterForFBDS);
}
