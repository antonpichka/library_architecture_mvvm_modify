...
/// An example of a class name in a real project: DeleteListMovieToSqfliteServiceParameterStringFBDSUsingDeleteListParameterStringForUuid
/// ParameterString - with a parameter for delete list
...
abstract class DeleteListModelToNamedServiceParameterNamedFBDS<Z extends Object,X extends Object,C extends Object> {
  Result<Z>? deleteListModelToNamedServiceParameterNamed(
      X? parameter,
      C? parameterForFBDS);
}