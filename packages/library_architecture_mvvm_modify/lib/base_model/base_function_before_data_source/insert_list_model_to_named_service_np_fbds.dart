...
/// An example of a class name in a real project: InsertListMovieToSqfliteServiceNPFBDSUsingInsertListNP
/// NP - no parameter
...
abstract base class InsertListModelToNamedServiceNPFBDS<X extends Object,
    C extends Object> {
  Result<X>? insertListModelToNamedServiceNP(C? parameterForFBDS);
}
