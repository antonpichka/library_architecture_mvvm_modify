...
/// An example of a class name in a real project: GetMovieFromSqfliteServiceParameterDoubleFBDS
/// ParameterDouble - with a parameter (with such an SQL query (SELECT * FROM movies WHERE rating = :rating LIMIT 1;)
abstract base class BaseGetModelFromNamedServiceParameterNamedFBDS<
    X extends BaseModel, C extends Object> {
  X? getModelFromNamedServiceParameterNamedFBDS(C? parameter);
}
