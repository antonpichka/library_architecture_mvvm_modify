...
/// An example of a class name in a real project: UpdateListMovieToSqfliteServiceNPFBDSUsingUpdateListNP
/// NP - no parameter
...
abstract base class UpdateListModelToNamedServiceNPFBDS<X extends Object,
    C extends Object> {
  Result<X>? updateListModelToNamedServiceNP(C? parameterForFBDS);
}
