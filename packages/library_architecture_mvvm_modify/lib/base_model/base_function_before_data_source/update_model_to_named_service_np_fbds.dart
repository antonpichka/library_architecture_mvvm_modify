...
/// An example of a class name in a real project: UpdateMovieToSqfliteServiceNPFBDSUsingUpdateNP
/// NP - no parameter
...
abstract base class UpdateModelToNamedServiceNPFBDS<X extends Object,
    C extends Object> {
  Result<X>? updateModelToNamedServiceNP(C? parameterForFBDS);
}
