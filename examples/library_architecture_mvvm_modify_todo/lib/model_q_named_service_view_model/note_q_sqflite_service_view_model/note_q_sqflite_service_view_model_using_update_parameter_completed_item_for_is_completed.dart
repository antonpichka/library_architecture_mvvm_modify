...
class NoteQSqfliteServiceViewModelUsingUpdateParameterCompletedItemForIsCompleted<T extends Note,Y extends ListNote<T>>
    extends BaseModelQNamedServiceViewModel<T,Y>
    implements UpdateModelToNamedServiceParameterNamedDataSource<int,CompletedItem>
{
  @protected
  final sqfliteService = SqfliteService();

  Future<Result<int>?> updateNoteToSqfliteServiceParameterCompletedItem(CompletedItem parameter) {
    return super.updateModelToNamedServiceParameterNamed<int,CompletedItem>(parameter);
  }
  ...
  @protected
  @override
  Future<Result<int>?> updateModelToNamedServiceParameterNamedDS(CompletedItem? parameter)
  async {
    try {
      ...
      final result = await database?.rawUpdate(
          ...
          [parameter?.getConverterFromIsCompletedToIntParameterIsCompleted,parameter?.uuId]);
