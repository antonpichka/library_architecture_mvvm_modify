...
class NoteQSqfliteServiceViewModelUsingUpdateListParameterBoolForIsCompleted<T extends Note,Y extends ListNote<T>>
    extends BaseModelQNamedServiceViewModel<T,Y>
    implements UpdateListModelToNamedServiceParameterNamedDataSource<int,bool>
{
  @protected
  final sqfliteService = SqfliteService();

  Future<Result<int>?> updateListNoteToSqfliteServiceParameterBool(bool parameter) {
    return super.updateListModelToNamedServiceParameterNamed<int,bool>(parameter);
  }
  ...
  @protected
  @override
  Future<Result<int>?> updateListModelToNamedServiceParameterNamedDS(bool? parameter)
  async {
    try {
