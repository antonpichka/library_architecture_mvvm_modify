...
class NotesOverviewFilterButtonWidgetListViewModel {
  @protected
      ...
      EnumNoteSorted enumNoteSorted)
  {
    ...
    notesIsLoadingQThereIsStateViewModel
        .getNotesIsLoading
        ?.setTwoParametersNamedForNotesOverviewFilterButtonWidget(enumNoteSorted,noteQThereIsStateViewModel.getListNoteUsingCloneListNoteForSuccess!);
    notesIsLoadingQThereIsStateViewModel
        .notifyStreamNotesIsLoading();
  }
}