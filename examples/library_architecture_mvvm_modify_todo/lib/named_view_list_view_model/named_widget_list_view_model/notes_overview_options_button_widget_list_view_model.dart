...
class NotesOverviewOptionsButtonWidgetListViewModel {
  ...
  Future<void> callMethodUpdateListNoteToSqfliteServiceParameterBoolAndInGeneralOneTask(
      EnumNoteOption enumNoteOption)
  async {
    if(notesIsLoadingQThereIsStateViewModel
        .getNotesIsLoading
        ?.isOneParametersNamedForNotesOverviewOptionsButtonWidget() ?? false)
    {
      return;
    }
    noteOptionQThereIsStateViewModel
        .getNoteOption
        ?.setOneParametersNamedForNotesOverviewOptionsButtonWidget = enumNoteOption;
    noteOptionQThereIsStateViewModel
        .notifyStreamNoteOption();
    notesIsLoadingQThereIsStateViewModel
        .getNotesIsLoading
        ?.setOneParametersNamedForNotesOverviewOptionsButtonWidget();
    notesIsLoadingQThereIsStateViewModel
        .notifyStreamNotesIsLoading();
    if(noteOptionQThereIsStateViewModel
        .getNoteOption
        ?.isFourParametersNamedForNotesOverviewOptionsButtonWidget() ?? false)
    {
      await updateListNoteToSqfliteServiceParameterBoolAndInGeneralOneTask(false);
      return;
    }
    if(noteOptionQThereIsStateViewModel
        .getNoteOption
        ?.isFiveParametersNamedForNotesOverviewOptionsButtonWidget() ?? false)
    {
      await updateListNoteToSqfliteServiceParameterBoolAndInGeneralOneTask(false);
      return;
    }
  ...
  @protected
  Future<void> updateListNoteToSqfliteServiceParameterBoolAndInGeneralOneTask(bool isCompleted)
  async {
    // 1
    final result = await noteQSqfliteServiceViewModelUsingUpdateListParameterBoolForIsCompleted
    ...
    noteQThereIsStateViewModel
        .getListNote
        ?.setOneParametersNamedForNotesOverviewOptionsButtonWidget = isCompleted;
    notesIsLoadingQThereIsStateViewModel
        .getNotesIsLoading
        ?.setThreeParametersNamedForNotesOverviewOptionsButtonWidget(noteSortedQThereIsStateViewModel.getNoteSorted!.getOneParametersNamedForNotesOverviewOptionsButtonWidget!, noteQThereIsStateViewModel.getListNoteUsingCloneListNoteForSuccess!);
    noteOptionQThereIsStateViewModel
        .getNoteOption
        ?.setTwoParametersNamedForNotesOverviewOptionsButtonWidget = noteQThereIsStateViewModel.getListNoteUsingCloneListNoteForSuccess!;
    notesIsLoadingQThereIsStateViewModel
        .notifyStreamNotesIsLoading();
    noteOptionQThereIsStateViewModel
        .notifyStreamNoteOption();
