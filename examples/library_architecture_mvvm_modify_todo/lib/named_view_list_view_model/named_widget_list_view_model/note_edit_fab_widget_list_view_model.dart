...
class NoteEditFabWidgetListViewModel {
  ...
  @protected
  final NoteQSqfliteServiceViewModelUsingUpdateParameterNote noteQSqfliteServiceViewModelUsingUpdateParameterNote;
  ...
  Future<void> updateNoteToSqfliteServiceParameterNoteUsingFBDSAndInGeneralOneTask(
  ...
  async {
    ...
    final result = await noteQSqfliteServiceViewModelUsingUpdateParameterNote
        .updateNoteToSqfliteServiceParameterNoteUsingFBDS(getNoteForUpdateNoteToSqfliteServiceParameterNoteUsingFBDSAndInGeneralOneTask());
    if(result
        !.exceptionController
  ...
  @protected
  Note getNoteForUpdateNoteToSqfliteServiceParameterNoteUsingFBDSAndInGeneralOneTask() {
    noteQThereIsStateViewModel
        .getNote
        ?.name = stringsQThereIsStateViewModelForTitle.getStrings?.field ?? "";
    noteQThereIsStateViewModel
        .getNote
        ?.description = stringsQThereIsStateViewModelForDescription.getStrings?.field ?? "";
