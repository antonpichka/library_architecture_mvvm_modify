...
class NotesListViewWidgetListViewModel {
  ...
  @protected
  final NoteQSqfliteServiceViewModelUsingGetListNP noteQSqfliteServiceViewModelUsingGetListNP;
  @protected
  final NoteQSqfliteServiceViewModelUsingUpdateParameterCompletedItemForIsCompleted noteQSqfliteServiceViewModelUsingUpdateParameterCompletedItemForIsCompleted;
  @protected
  ...
  Future<void> deleteNoteToSqfliteServiceParameterStringAndInGeneralOneTask(
      Note? note,
      Function(Note lastDeletedNote) callbackSuccess)
  async {
    // 1
  ...
  Future<void> updateNoteToSqfliteServiceParameterCompletedItemAndInGeneralOneTask(Note? note,bool? isCheckBox)
  async {
    note?.setOneParametersNamedForNotesListViewWidget = isCheckBox!;
    // 1
    final result = await noteQSqfliteServiceViewModelUsingUpdateParameterCompletedItemForIsCompleted
        .updateNoteToSqfliteServiceParameterCompletedItem(getCompletedItemForUpdateNoteToSqfliteServiceParameterCompletedItemAndInGeneralOneTask(note));
    if(result
        !.exceptionController
        .isNotEqualsNullParameterException())
    {
  ...
  @protected
  CompletedItem getCompletedItemForUpdateNoteToSqfliteServiceParameterCompletedItemAndInGeneralOneTask(
      Note? note)
  {
