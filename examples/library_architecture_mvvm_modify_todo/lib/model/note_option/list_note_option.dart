    ...
    extends BaseListModel<T>
{
  ...
  @visibleForTesting
  static ListNoteOption get getListNoteOptionForSuccessWhereUnitTest => ListNoteOption.success([
    NoteOption.success(EnumNoteOption.toggleAll, ListNote.success([Note.successWhereIsExistsParameterUuid("","","",false),Note.successWhereIsExistsParameterUuid("","","",false)])),
    NoteOption.success(EnumNoteOption.toggleAll, ListNote.success([Note.successWhereIsExistsParameterUuid("","","",false),Note.successWhereIsExistsParameterUuid("","","",false)]))]);
}