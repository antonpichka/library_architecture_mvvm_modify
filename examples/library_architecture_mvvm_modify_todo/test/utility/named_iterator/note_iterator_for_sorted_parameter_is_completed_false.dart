...
void main() {
  test('noteIteratorForSortedParameterIsCompletedFalse success', () {
    ...
    final noteIteratorForSortedParameterIsCompletedFalse = NoteIteratorForSortedParameterIsCompletedFalse();
    noteIteratorForSortedParameterIsCompletedFalse.listModel = listNote;
    final sortedListModelParameterListModel = noteIteratorForSortedParameterIsCompletedFalse.getSortedListModelParameterListModel;
