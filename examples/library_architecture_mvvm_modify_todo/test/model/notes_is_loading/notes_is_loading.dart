...
void main() {
  group('get success', () {
    test('getEnumNotesIsLoadingForNotesListViewWidget', () {
      final notesIsLoading = NotesIsLoading.getNotesIsLoadingForSuccessWhereUnitTest;
      expect(notesIsLoading.getEnumNotesIsLoadingForNotesListViewWidget,EnumNotesIsLoadingForNotesListViewWidget.success);
    });
  ...
  group('set success', () {
    ...
    test('setTwoParametersNamedForNotesListViewWidget', () {
      final notesIsLoading = NotesIsLoading.getNotesIsLoadingForSuccessWhereUnitTest;
      notesIsLoading.setTwoParametersNamedForNotesListViewWidget = ListNote.getListNoteForSuccessWhereUnitTest;
      expect(notesIsLoading.isLoading,false);
      expect(notesIsLoading.listNote!.listModel!.length,2);
      expect(notesIsLoading
          .exceptionController
          .enumWhatIsTheException,EnumWhatIsTheException.noException);
    });
    test('setThreeParametersNamedForNotesListViewWidget', () {
      final notesIsLoading = NotesIsLoading.getNotesIsLoadingForSuccessWhereUnitTest;
      notesIsLoading.setThreeParametersNamedForNotesListViewWidget = ListNote.getListNoteForSuccessWhereUnitTest;
      expect(notesIsLoading.isLoading,false);
      expect(notesIsLoading.listNote!.listModel!.length,2);
      expect(notesIsLoading
          .exceptionController
    ...
    test('setFourParametersNamedForNotesListViewWidget', () {
      final notesIsLoading = NotesIsLoading.getNotesIsLoadingForSuccessWhereUnitTest;
      notesIsLoading.setFourParametersNamedForNotesListViewWidget(EnumNoteSorted.isCompleted,ListNote.getListNoteForSuccessWhereUnitTest);
      expect(notesIsLoading.listNote!.listModel!.length,0);
    });
    test('setFiveParametersNamedForNotesListViewWidget', () {
      final notesIsLoading = NotesIsLoading.getNotesIsLoadingForSuccessWhereUnitTest;
      notesIsLoading.setFiveParametersNamedForNotesListViewWidget(EnumNoteSorted.isCompleted,ListNote.getListNoteForSuccessWhereUnitTest);
      expect(notesIsLoading.listNote!.listModel!.length,0);
    });
    test('setSixParametersNamedForNotesListViewWidget', () {
      final notesIsLoading = NotesIsLoading.getNotesIsLoadingForSuccessWhereUnitTest;
      notesIsLoading.setSixParametersNamedForNotesListViewWidget(EnumNoteSorted.isCompleted,ListNote.getListNoteForSuccessWhereUnitTest);
      expect(notesIsLoading.listNote!.listModel!.length,0);
    });
    ...
    test('setTwoParametersNamedForNotesOverviewFilterButtonWidget', () {
      final notesIsLoading = NotesIsLoading.getNotesIsLoadingForSuccessWhereUnitTest;
      notesIsLoading.setTwoParametersNamedForNotesOverviewFilterButtonWidget(EnumNoteSorted.isCompleted,ListNote.getListNoteForSuccessWhereUnitTest);
      expect(notesIsLoading.isLoading,false);
      expect(notesIsLoading.listNote!.listModel!.length,0);
    });
    ...
    test('setThreeParametersNamedForNotesOverviewOptionsButtonWidget', () {
      final notesIsLoading = NotesIsLoading.getNotesIsLoadingForSuccessWhereUnitTest;
      notesIsLoading.setThreeParametersNamedForNotesOverviewOptionsButtonWidget(EnumNoteSorted.isCompleted,ListNote.getListNoteForSuccessWhereUnitTest);
      expect(notesIsLoading.isLoading,false);
      expect(notesIsLoading.listNote!.listModel!.length,0);
    });
  });
  group('is success', () {
    test('isOneParametersNamedForNotesOverviewOptionsButtonWidget', () {
      final notesIsLoading = NotesIsLoading.getNotesIsLoadingForSuccessWhereUnitTest;
      expect(notesIsLoading.isOneParametersNamedForNotesOverviewOptionsButtonWidget(),false);
    });
    test('isOneParametersNamedForNotesOverviewFilterButtonWidget', () {
      final notesIsLoading = NotesIsLoading.getNotesIsLoadingForSuccessWhereUnitTest;
      expect(notesIsLoading.isOneParametersNamedForNotesOverviewFilterButtonWidget(),false);
    });
  });
}