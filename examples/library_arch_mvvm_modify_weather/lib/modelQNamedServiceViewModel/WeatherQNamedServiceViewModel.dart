...
abstract class WeatherQNamedServiceViewModel<T extends Weather,Y extends ListWeather<T>,DataSource extends Object>
    extends BaseModelQNamedServiceViewModel<T,Y,DataSource>
{
  WeatherQNamedServiceViewModel.thereIsDataSource(super.dataSource, super.iCloneStreamModelForSuccess) : super.thereIsDataSource();
