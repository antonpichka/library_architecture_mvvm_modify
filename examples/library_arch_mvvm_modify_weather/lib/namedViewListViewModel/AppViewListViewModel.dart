...
import 'package:library_arch_mvvm_modify_weather/model/settings/cloneStreamSettingsForSuccess/InitializedStreamSettings.dart';
    ...
    extends BaseNamedViewListViewModel
{
  ...
  SettingsQHiveServiceViewModelUsingGetNP<Settings,ListSettings>(InitializedStreamSettings(),SettingsForLocalExceptionTIP(),SettingsForObjectTIP(),SettingsForDefaultWhereKeyNotFoundNP());
