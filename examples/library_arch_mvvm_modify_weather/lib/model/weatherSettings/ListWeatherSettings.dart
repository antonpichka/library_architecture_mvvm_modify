...
class ListWeatherSettings<T extends WeatherSettings> extends BaseListModel<T> {
  ListWeatherSettings.success(super.listModel) : super.success();
  ListWeatherSettings.exception(super.exception) : super.exception();

  static ListWeatherSettings get getListWeatherSettingsForSuccess =>
      ListWeatherSettings.success([]);
}
