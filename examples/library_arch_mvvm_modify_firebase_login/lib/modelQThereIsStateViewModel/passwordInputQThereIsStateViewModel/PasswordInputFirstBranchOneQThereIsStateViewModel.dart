...
class PasswordInputFirstBranchOneQThereIsStateViewModel<T extends PasswordInputFirstBranchOne,Y extends ListPasswordInputFirstBranchOne<T>>
    extends PasswordInputQThereIsStateViewModel<T,Y>
{
  PasswordInputFirstBranchOneQThereIsStateViewModel(super.iInitializedStreamModel);
}