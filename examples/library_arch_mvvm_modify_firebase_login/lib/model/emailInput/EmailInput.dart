...
base class EmailInput extends BaseModel {
  Email? email;

  EmailInput.success(this.email) : super.success(email?.value);

  static EmailInput get getEmailInputForSuccess =>
      EmailInput.success(const Email.pure());
  ...
  set setOneParametersNamedForEmailInputWidget(String str) =>
