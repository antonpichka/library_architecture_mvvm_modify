...
void main() {
  test(
      'updateUserToFirebaseAuthServiceParameterLoginFBDSUsingInsertParameterRegistrationAndUpdateParameterLogin success',
      () {
    final fbds =
    ...
    final result =
        fbds.updateModelToNamedServiceParameterNamed(parameter, null);
