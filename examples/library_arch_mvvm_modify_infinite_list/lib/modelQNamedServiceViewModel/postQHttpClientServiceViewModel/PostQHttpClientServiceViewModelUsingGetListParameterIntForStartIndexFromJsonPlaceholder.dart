...
{
  PostQHttpClientServiceViewModelUsingGetListParameterIntForStartIndexFromJsonPlaceholder(IModelForNamedTIP<T,Map<String,dynamic>> iModelForMapTIP,IListModelForNamedTIP<Y,List<T>> iListPostForArrayListPostTIP, IListModelForNamedTIP<Y,NetworkException> iListPostForNetworkExceptionTIP,IListModelForNamedTIP<Y,LocalException> iListPostForLocalExceptionTIP,ICloneModelForSuccess<T,Y> iCloneModelForSuccess,ICloneStreamModelForSuccess<T,Y> iCloneStreamModelForSuccess)
      : super.thereIsDataSource(PostQHttpClientServiceDataSourceUsingGetListParameterIntForStartIndexFromJsonPlaceholder(iModelForMapTIP,iListPostForArrayListPostTIP,iListPostForNetworkExceptionTIP,iListPostForLocalExceptionTIP),iCloneModelForSuccess,iCloneStreamModelForSuccess);
