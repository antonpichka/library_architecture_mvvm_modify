...
{
  BoolQNoServiceViewModelUsingGetNPForAntiSpam(ICloneStreamModelForSuccess<T,Y> iCloneStreamModelForSuccess) : super([EnumBaseModelAndBaseListModelVM.getModelFromNamedServiceNP],iCloneStreamModelForSuccess);
