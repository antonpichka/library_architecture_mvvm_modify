...
base class PostsListFirstBranchOneWidget extends PostsListWidget {
  const PostsListFirstBranchOneWidget(
      PostsListFirstBranchOneWidgetListViewModel lo)
      : super(lo);
...
base class PostsListFirstBranchOneWidgetState extends PostsListWidgetState {
  @override
  ...
  Widget buildNoInternetItLocalException(ListPost? listPost) {
    return const Center(
        child: Text('no Internet. Connect to the Internet EXT EXT'));
  }
}
