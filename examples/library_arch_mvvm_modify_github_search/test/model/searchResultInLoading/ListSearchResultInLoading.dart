...
void main() {
  group('get success', () {
    test('getEnumListSearchResultInLoadingForSearchBodyWidget', () {
      final listSearchResultInLoading =
          ListSearchResultInLoading.getListSearchResultInLoadingForSuccess;
      expect(
          listSearchResultInLoading
              .getEnumListSearchResultInLoadingForSearchBodyWidget,
    ...
    test('getOneParametersNamedForSearchBodyWidget', () {
      final listSearchResultInLoading =
          ListSearchResultInLoading.getListSearchResultInLoadingForSuccess;
      expect(listSearchResultInLoading.getOneParametersNamedForSearchBodyWidget,
          null);
    });
  });
  group('set success', () {
    ...
    test('setTwoParametersNamedForSearchBarWidget', () {
      final listSearchResultInLoading =
          ListSearchResultInLoading.getListSearchResultInLoadingForSuccess;
      listSearchResultInLoading.setTwoParametersNamedForSearchBarWidget =
      ...
      expect(
          listSearchResultInLoading.exceptionController.enumWhatIsTheException,
