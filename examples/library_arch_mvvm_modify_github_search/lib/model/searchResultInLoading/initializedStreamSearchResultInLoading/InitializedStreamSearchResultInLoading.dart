...
final class InitializedStreamSearchResultInLoading
    implements
        IInitializedStreamModel<SearchResultInLoading,
            ListSearchResultInLoading> {
  @override
  IStreamModel<SearchResultInLoading, ListSearchResultInLoading>?
      initializedStreamModel() {
    return DefaultStreamModel<SearchResultInLoading, ListSearchResultInLoading>(
