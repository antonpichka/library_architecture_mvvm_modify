...
{
  SearchResultQGithubCacheAndHttpClientServiceViewModelUsingGetListParameterStringForSearchFromApiGithub(ICloneStreamModelForSuccess<T,Y> iCloneStreamModelForSuccess,IListModelForNamedTIP<Y,Map<String,dynamic>> iListSearchResultForMapTIP,IListModelForNamedTIP<Y,NetworkException> iListSearchResultForNetworkExceptionTIP,IListModelForNamedTIP<Y,LocalException> iListSearchResultForLocalExceptionTIP,IListModelForNamedTIP<Y,Object> iListSearchResultForObjectTIP,{String baseUrl = constUrlApiGithubComSearchRepositories}) : super.thereIsDataSource(SearchResultQGithubCacheAndHttpClientServiceDataSourceUsingGetListParameterStringForSearchFromApiGithub(iListSearchResultForMapTIP,iListSearchResultForNetworkExceptionTIP,iListSearchResultForLocalExceptionTIP,iListSearchResultForObjectTIP,baseUrl: baseUrl),iCloneStreamModelForSuccess);
