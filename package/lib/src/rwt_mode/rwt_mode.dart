...
final class RWTMode {
  ...
  /// Where to use ? - use in 'NamedVM' class
  RWTMode(this._enumRWTMode, List<NamedCallback> listNamedCallbackWRelease,
      List<NamedCallback> listNamedCallbackWTest)
      : _mapStringWNamedCallbackWRelease =
            _getMapStringWNamedCallbackFromListNamedCallback(
                listNamedCallbackWRelease),
        _mapStringWNamedCallbackWTest =
            _getMapStringWNamedCallbackFromListNamedCallback(
                listNamedCallbackWTest);
  ...
  /// Where to use ? - here
  static Map<String, NamedCallback>
      _getMapStringWNamedCallbackFromListNamedCallback(
          List<NamedCallback> listNamedCallback) {
  ...
  NamedCallback getNamedCallbackFromName(String name) {
    final mapStringWNamedCallbackWhereSelectModParametersThree =
        _getMapStringWNamedCallbackWhereSelectModParametersThree;
    if (!mapStringWNamedCallbackWhereSelectModParametersThree
        .containsKey(name)) {
      return throw LocalException(this, EnumGuilty.developer,
          "RWTModeQQGetNamedCallbackFromName", "no exists key: $name");
    }
  ...
  /// Where to use ? - here
  Map<String, NamedCallback>
      get _getMapStringWNamedCallbackWhereSelectModParametersThree {
