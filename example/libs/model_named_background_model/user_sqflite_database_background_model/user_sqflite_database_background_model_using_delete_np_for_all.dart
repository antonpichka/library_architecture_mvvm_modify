...
import '../../model/user/fbds/delete_user_to_sqflite_database_fbds_using_delete_tip.dart';
...
class UserSqfliteDatabaseBackgroundModelUsingDeleteNPForAll extends UserSqfliteDatabaseBackgroundModel {
  UserSqfliteDatabaseBackgroundModelUsingDeleteNPForAll() : super(
      UserSqfliteDatabaseDataSourceUsingDeleteNPForAll.db,
      null,
      null,
      null,
      null,
      DeleteUserToSqfliteDatabaseFBDSUsingDeleteTIP(),
      null
  );
