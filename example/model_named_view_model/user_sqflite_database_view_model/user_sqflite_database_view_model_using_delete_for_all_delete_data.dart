...
import '../../model/user/user_cidbuacbfvm/delete_user_to_sqflite_database_using_delete_for_all_delete_data_there_is_parameter_cidbuacbfvm.dart';
...
class UserSqfliteDatabaseViewModelUsingDeleteForAllDeleteData extends UserSqfliteDatabaseViewModel {
  UserSqfliteDatabaseViewModelUsingDeleteForAllDeleteData() : super(
      ...
      null,
      null,
      DeleteUserToSqfliteDatabaseUsingDeleteForAllDeleteDataThereIsParameterCIDBUACBFVM(),
      null
  );
