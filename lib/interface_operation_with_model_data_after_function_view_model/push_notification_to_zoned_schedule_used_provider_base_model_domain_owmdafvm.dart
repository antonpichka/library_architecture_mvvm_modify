...
abstract class PushNotificationToZonedScheduleUsedProviderBaseModelDomainOWMDAFVM<T extends BaseModelDomain>
    implements ProviderBaseModelDomainOWMDAFVM<T>
{
  void pushNotificationToZonedScheduleOWMDAFVM();
}