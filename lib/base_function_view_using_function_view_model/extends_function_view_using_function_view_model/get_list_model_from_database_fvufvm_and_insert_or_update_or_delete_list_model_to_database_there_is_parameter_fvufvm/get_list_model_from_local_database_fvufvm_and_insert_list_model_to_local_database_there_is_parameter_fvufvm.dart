...
class GetListModelFromLocalDatabaseFVUFVMAndInsertListModelToLocalDatabaseThereIsParameterFVUFVM
    extends BaseFVUFVMSpecificallyNoTIPNoNS<GetListModelFromLocalDatabaseFVMAndInsertListModelToLocalDatabaseThereIsParameterFVM>
{
  @override
  Future<void> mainMethod(GetListModelFromLocalDatabaseFVMAndInsertListModelToLocalDatabaseThereIsParameterFVM  mainMethod,
  ...
  async {
    await FunctionViewModel.getListModelFromLocalDatabaseFVMAndInsertListModelToLocalDatabaseThereIsParameterFVM(
        mainMethod,
