...
class GetListModelFromNetworkDatabaseFVUFVMUCNEAndDeleteListModelToLocalDatabaseThereIsParameterFVUFVM
    extends BaseFVUFVMUCNESpecificallyNoTIPNoNS<GetListModelFromNetworkDatabaseFVMAndDeleteListModelToLocalDatabaseThereIsParameterFVM>
{
  @override
  Future<void> mainMethod(GetListModelFromNetworkDatabaseFVMAndDeleteListModelToLocalDatabaseThereIsParameterFVM mainMethod,
  ...
  async {
    await FunctionViewModel.getListModelFromNetworkDatabaseFVMAndDeleteListModelToLocalDatabaseThereIsParameterFVM(
        mainMethod,
