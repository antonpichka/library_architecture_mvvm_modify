...
class GetListModelFromNetworkDatabaseFVUFVMUCNEAndInsertListModelToLocalDatabaseThereIsParameterFVUFVM
    extends BaseFVUFVMUCNESpecificallyNoTIPNoNS<GetListModelFromNetworkDatabaseFVMAndInsertListModelToLocalDatabaseThereIsParameterFVM>
{
  @override
  Future<void> mainMethod(GetListModelFromNetworkDatabaseFVMAndInsertListModelToLocalDatabaseThereIsParameterFVM mainMethod,
  ...
  async {
    await FunctionViewModel.getListModelFromNetworkDatabaseFVMAndInsertListModelToLocalDatabaseThereIsParameterFVM(
        mainMethod,
