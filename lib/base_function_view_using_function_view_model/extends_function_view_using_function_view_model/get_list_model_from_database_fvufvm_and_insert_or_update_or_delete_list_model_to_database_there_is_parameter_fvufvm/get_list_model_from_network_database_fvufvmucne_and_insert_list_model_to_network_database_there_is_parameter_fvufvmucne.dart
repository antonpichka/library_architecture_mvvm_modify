...
class GetListModelFromNetworkDatabaseFVUFVMUCNEAndInsertListModelToNetworkDatabaseThereIsParameterFVUFVMUCNE
    extends BaseFVUFVMUCNESpecificallyNoTIPNoNS<GetListModelFromNetworkDatabaseFVMAndInsertListModelToNetworkDatabaseThereIsParameterFVM>
{
  @override
  Future<void> mainMethod(GetListModelFromNetworkDatabaseFVMAndInsertListModelToNetworkDatabaseThereIsParameterFVM mainMethod,
  ...
  async {
    await FunctionViewModel.getListModelFromNetworkDatabaseFVMAndInsertListModelToNetworkDatabaseThereIsParameterFVM(
        mainMethod,
