...
class GetListModelFromLocalDatabaseFVUFVMAndInsertListModelToNetworkDatabaseThereIsParameterFVUFVMUCNE
    extends BaseFVUFVMUCNESpecificallyNoTIPNoNS<GetListModelFromLocalDatabaseFVMAndInsertListModelToNetworkDatabaseThereIsParameterFVM>
{
  @override
  Future<void> mainMethod(GetListModelFromLocalDatabaseFVMAndInsertListModelToNetworkDatabaseThereIsParameterFVM  mainMethod,
  ...
  async {
    await FunctionViewModel.getListModelFromLocalDatabaseFVMAndInsertListModelToNetworkDatabaseThereIsParameterFVM(
        mainMethod,
