...
import 'package:library_architecture_mvvm_modify/function_view/no_there_is_parameter_for_methods_type_future_function_view.dart';
...
class GetListModelFromLocalDatabaseFVUFVM extends BaseFunctionViewUsingFunctionViewModel
        implements NoThereIsParameterForMethodsTypeFutureFunctionView<GetListModelFromLocalDatabaseFVM>
{
  @override
  Future<void> mainMethod(GetListModelFromLocalDatabaseFVM mainMethod, Function functionForResultSuccess, Function(DomainException p1) functionForResultDomainException, Function(LocalException p1) functionForResultLocalException, Function(NetworkException p1) functionForResultNetworkException) async {
  ...
  Future<void> mainMethodAndNotifyStream(
      GetListModelFromLocalDatabaseFVM mainMethod,
      BaseViewModel<BaseModelDomain, BaseListModelDomain<BaseModelDomain>> baseViewModel,
      Function functionForResultSuccess,
      Function(DomainException p1) functionForResultDomainException,
      Function(LocalException p1) functionForResultLocalException,
      Function(NetworkException p1) functionForResultNetworkException) async
  {
    await FunctionViewModel
        .callToMethodGetListModelFromLocalDatabaseAndUseTheSettersFVM(
        mainMethod,
