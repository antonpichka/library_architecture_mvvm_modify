...
{
  @override
  Future<void> mainMethod(GetListModelFromLocalDatabaseFVM mainMethod,
  ...
  async {
    await FunctionViewModel.callToMethodGetListModelFromLocalDatabaseAndUseTheSettersFVM(
      mainMethod,
