...
class GetListModelFromLNDatabaseFVUFVMUCNE
    extends BaseFVUFVMUCNESpecificallyNoTIPYesNS<GetListModelFromLNDatabaseFVM>
{
  @override
  Future<void> mainMethod(GetListModelFromLNDatabaseFVM mainMethod,
  ...
  async {
    await FunctionViewModel.callToMethodGetListModelFromLNDatabaseAndUseTheSettersFVM(
        mainMethod,
