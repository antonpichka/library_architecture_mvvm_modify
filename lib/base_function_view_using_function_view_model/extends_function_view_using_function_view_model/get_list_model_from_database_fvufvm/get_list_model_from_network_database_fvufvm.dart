...
class GetListModelFromNetworkDatabaseFVUFVM extends BaseFunctionViewUsingFunctionViewModel
        implements NoThereIsParameterForMethodsTypeFutureFunctionView<GetListModelFromNetworkDatabaseFVM>
{
  @override
  Future<void> mainMethod(GetListModelFromNetworkDatabaseFVM mainMethod, Function functionForResultSuccess, Function(DomainException p1) functionForResultDomainException, Function(LocalException p1) functionForResultLocalException, Function(NetworkException p1) functionForResultNetworkException) async {
