...
class DeleteModelToLocalDatabaseThereIsParameterFVUFVM
    extends BaseFVUFVMSpecificallyYesTIPYesNS<DeleteModelToLocalDatabaseThereIsParameterFVM,BaseModelDomain>
{
  @override
  Future<void> mainMethod(DeleteModelToLocalDatabaseThereIsParameterFVM mainMethod,
  ...
  async {
    await FunctionViewModel.deleteModelToLocalDatabaseThereIsParameterFVM(
        mainMethod,
