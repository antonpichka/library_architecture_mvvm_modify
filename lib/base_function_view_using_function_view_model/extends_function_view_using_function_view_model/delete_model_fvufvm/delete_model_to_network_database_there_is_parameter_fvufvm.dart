...
class DeleteModelToNetworkDatabaseThereIsParameterFVUFVM
    extends BaseFVUFVMSpecificallyYesTIPYesNS<DeleteModelToNetworkDatabaseThereIsParameterFVM,BaseModelDomain>
{
  @override
  Future<void> mainMethod(DeleteModelToNetworkDatabaseThereIsParameterFVM mainMethod, Function functionForResultSuccess, Function(DomainException p1) functionForResultDomainException, Function(LocalException p1) functionForResultLocalException, Function(NetworkException p1) functionForResultNetworkException) async {
    await FunctionViewModel.deleteModelToNetworkDatabaseThereIsParameterFVM(
        mainMethod,
