...
class GetListModelFromLNDatabaseThereIsParameterFVUFVM extends BaseFunctionViewUsingFunctionViewModel
    implements ThereIsParameterForMethodsTypeFutureFunctionView<GetListModelFromLNDatabaseThereIsParameterFVM,BaseTypeParameter>
{
  @override
  ...
  @override
  Future<void> mainMethodAndNotifyStream(GetListModelFromLNDatabaseThereIsParameterFVM mainMethod, BaseViewModel<BaseModelDomain, BaseListModelDomain<BaseModelDomain>> baseViewModel, Function functionForResultSuccess, Function(DomainException p1) functionForResultDomainException, Function(LocalException p1) functionForResultLocalException, Function(NetworkException p1) functionForResultNetworkException) async {
    await FunctionViewModel
        .callToMethodGetListModelFromLNDatabaseThereIsParameterAndUseTheSettersFVM(
        mainMethod,
        functionForResultSuccess,
  ...
  @override
  Future<void> setObjectAndMainMethod(GetListModelFromLNDatabaseThereIsParameterFVM mainMethod, BaseViewModel<BaseModelDomain, BaseListModelDomain<BaseModelDomain>> baseViewModel, BaseTypeParameter object, Function functionForResultSuccess, Function(DomainException p1) functionForResultDomainException, Function(LocalException p1) functionForResultLocalException, Function(NetworkException p1) functionForResultNetworkException) async {
