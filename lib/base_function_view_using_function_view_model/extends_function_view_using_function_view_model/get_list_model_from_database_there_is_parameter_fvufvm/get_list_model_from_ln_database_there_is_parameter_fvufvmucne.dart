...
class GetListModelFromLNDatabaseThereIsParameterFVUFVMUCNE
    extends BaseFVUFVMUCNESpecificallyYesTIPYesNS<GetListModelFromLNDatabaseThereIsParameterFVM,BaseTypeParameter>
{
  @override
  Future<void> mainMethod(GetListModelFromLNDatabaseThereIsParameterFVM mainMethod,
  ...
  async {
    await FunctionViewModel.callToMethodGetListModelFromLNDatabaseThereIsParameterAndUseTheSettersFVM(
        mainMethod,
