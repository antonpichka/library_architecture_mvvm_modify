...
class UpdateModelToNetworkDatabaseThereIsParameterFVUFVM
    extends BaseFVUFVMSpecificallyYesTIPYesNS<UpdateModelToNetworkDatabaseThereIsParameterFVM,BaseModelDomain>
{
  @override
  Future<void> mainMethod(UpdateModelToNetworkDatabaseThereIsParameterFVM mainMethod, Function functionForResultSuccess, Function(DomainException p1) functionForResultDomainException, Function(LocalException p1) functionForResultLocalException, Function(NetworkException p1) functionForResultNetworkException) async {
    await FunctionViewModel.updateModelToNetworkDatabaseThereIsParameterFVM(
        mainMethod,
