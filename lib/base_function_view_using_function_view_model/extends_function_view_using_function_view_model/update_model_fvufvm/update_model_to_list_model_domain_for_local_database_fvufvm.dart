...
class UpdateModelToListModelDomainForLocalDatabaseFVUFVM
    extends BaseFVUFVMSpecificallyYesTIPYesNS<UpdateModelToListModelDomainForLocalDatabaseFVM,BaseModelDomain>
{
  @override
  Future<void> mainMethod(UpdateModelToListModelDomainForLocalDatabaseFVM mainMethod, Function functionForResultSuccess, Function(DomainException p1) functionForResultDomainException, Function(LocalException p1) functionForResultLocalException, Function(NetworkException p1) functionForResultNetworkException) async {
    FunctionViewModel.updateModelToListModelDomainForLocalDatabaseFVM(
        mainMethod,
