...
class DeleteListModelToListModelDomainForNetworkDatabaseFVUFVM
    extends BaseFVUFVMSpecificallyYesTIPYesNS<DeleteListModelToListModelDomainForNetworkDatabaseFVM,List<BaseModelDomain>>
{
  @override
  Future<void> mainMethod(DeleteListModelToListModelDomainForNetworkDatabaseFVM mainMethod,
      {Function functionForResultSuccess,
        Function(DomainException p1) functionForResultDomainException,
        Function(LocalException p1) functionForResultLocalException}) async
  {
    FunctionViewModel.deleteListModelToListModelDomainForNetworkDatabaseFVM(
        mainMethod,
