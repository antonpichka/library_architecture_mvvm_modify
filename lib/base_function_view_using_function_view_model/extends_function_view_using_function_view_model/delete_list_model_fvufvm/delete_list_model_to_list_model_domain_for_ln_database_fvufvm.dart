...
class DeleteListModelToListModelDomainForLNDatabaseFVUFVM
    extends BaseFVUFVMSpecificallyYesTIPYesNS<DeleteListModelToListModelDomainForLNDatabaseFVM,List<BaseModelDomain>>
{
  @override
  ...
  @override
  Future<void> mainMethod(DeleteListModelToListModelDomainForLNDatabaseFVM mainMethod, {Function functionForResultSuccess, Function(DomainException p1) functionForResultDomainException, Function(LocalException p1) functionForResultLocalException}) async
  {
    FunctionViewModel.deleteListModelToListModelDomainForLNDatabaseFVM(
      mainMethod,
