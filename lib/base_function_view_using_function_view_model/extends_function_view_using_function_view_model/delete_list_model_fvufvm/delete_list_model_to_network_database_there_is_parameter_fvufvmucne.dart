...
class DeleteListModelToNetworkDatabaseThereIsParameterFVUFVMUCNE
    extends BaseFVUFVMUCNESpecificallyYesTIPYesNS<DeleteListModelToNetworkDatabaseThereIsParameterFVM,List<BaseModelDomain>>
{
  @override
  Future<void> mainMethod(DeleteListModelToNetworkDatabaseThereIsParameterFVM mainMethod,
  ...
  async {
    await FunctionViewModel.deleteListModelToNetworkDatabaseThereIsParameterFVM(
        mainMethod,
