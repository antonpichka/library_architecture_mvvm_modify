...
class GetModelFromLocalDatabaseThereIsParameterFVUFVM extends BaseFunctionViewUsingFunctionViewModel
    implements ThereIsParameterForMethodsTypeFutureFunctionView<GetModelFromLocalDatabaseThereIsParameterFVM,BaseTypeParameter>
{
  @override
  ...
  @override
  Future<void> mainMethodAndNotifyStream(GetModelFromLocalDatabaseThereIsParameterFVM mainMethod, BaseViewModel<BaseModelDomain, BaseListModelDomain<BaseModelDomain>> baseViewModel, Function functionForResultSuccess, Function(DomainException p1) functionForResultDomainException, Function(LocalException p1) functionForResultLocalException, Function(NetworkException p1) functionForResultNetworkException) async {
    await FunctionViewModel
        .callToMethodGetModelFromLocalDatabaseThereIsParameterAndUseTheSettersFVM(
        mainMethod,
        functionForResultSuccess,
  ...
  @override
  Future<void> setObjectAndMainMethodAndNotifyStream(GetModelFromLocalDatabaseThereIsParameterFVM mainMethod, BaseViewModel<BaseModelDomain, BaseListModelDomain<BaseModelDomain>> baseViewModel, BaseTypeParameter object, Function functionForResultSuccess, Function(DomainException p1) functionForResultDomainException, Function(LocalException p1) functionForResultLocalException, Function(NetworkException p1) functionForResultNetworkException) async {
    setObject(baseViewModel, object);
    await FunctionViewModel
        .callToMethodGetModelFromLocalDatabaseThereIsParameterAndUseTheSettersFVM(
        mainMethod,
