...
{
  @override
  Future<void> mainMethod(GetModelFromLocalDatabaseThereIsParameterFVM mainMethod,
  ...
  async {
    await FunctionViewModel.callToMethodGetModelFromLocalDatabaseThereIsParameterAndUseTheSettersFVM(
        mainMethod,
