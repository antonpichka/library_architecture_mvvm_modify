...
class GetModelFromNetworkDatabaseThereIsParameterFVUFVMUCNE
    extends BaseFVUFVMUCNESpecificallyYesTIPYesNS<GetModelFromNetworkDatabaseThereIsParameterFVM,BaseTypeParameter>
{
  @override
  Future<void> mainMethod(GetModelFromNetworkDatabaseThereIsParameterFVM mainMethod,
  ...
  async {
    await FunctionViewModel.callToMethodGetModelFromNetworkDatabaseThereIsParameterAndUseTheSettersFVM(
        mainMethod,
