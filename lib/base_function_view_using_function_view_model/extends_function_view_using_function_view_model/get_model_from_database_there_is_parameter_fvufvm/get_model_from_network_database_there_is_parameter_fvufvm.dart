...
class GetModelFromNetworkDatabaseThereIsParameterFVUFVM
    extends BaseFVUFVMSpecificallyYesTIPYesNS<GetModelFromNetworkDatabaseThereIsParameterFVM,BaseTypeParameter>
{
  @override
  ...
  void setObject(BaseViewModel<BaseModelDomain, BaseListModelDomain<BaseModelDomain>> baseViewModel, BaseTypeParameter object) {
    baseViewModel.setBaseTypeParameterForGetModelLNDatabaseAndGetListLNDatabase(
        object,
        EnumBaseTypeParameterVM.getModelFromNetworkDatabaseThereIsParameter
    );
  }
}