...
class IteratorForListModelLocalDatabaseFVUFVM
    extends BaseFVUFVMSpecificallyYesTIPYesNS<IteratorForListModelLocalDatabaseFVM,EnumTypeParameter>
{
  @override
  Future<void> mainMethod(IteratorForListModelLocalDatabaseFVM mainMethod, Function functionForResultSuccess, Function(DomainException p1) functionForResultDomainException, Function(LocalException p1) functionForResultLocalException, Function(NetworkException p1) functionForResultNetworkException) async {
    await FunctionViewModel.callToMethodSetIteratorForListModelLocalDatabaseAndSetListModelLocalDatabaseUsingAnIteratorFVM(
        mainMethod,
