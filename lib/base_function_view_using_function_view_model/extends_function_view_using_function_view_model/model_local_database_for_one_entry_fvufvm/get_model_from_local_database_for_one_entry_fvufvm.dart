...
class GetModelFromLocalDatabaseForOneEntryFVUFVM 
    extends BaseFVUFVMSpecificallyNoTIPYesNS<ModelLocalDatabaseForOneEntryFVM>
{
  @override
  ...
  async {
    await FunctionViewModel.callToMethodGetModelFromLocalDatabaseForOneEntryAndUseTheSettersFVM(
        mainMethod,
