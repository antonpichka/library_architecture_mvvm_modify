...
class InsertModelToLNDatabaseThereIsParameterFVUFVM
    extends BaseFunctionViewUsingFunctionViewModel
    implements ThereIsParameterForMethodsTypeFutureFunctionView<InsertModelToLNDatabaseThereIsParameterFVM,BaseModelDomain>
{
  @override
  Future<void> mainMethod(InsertModelToLNDatabaseThereIsParameterFVM mainMethod, Function functionForResultSuccess, Function(DomainException p1) functionForResultDomainException, Function(LocalException p1) functionForResultLocalException, Function(NetworkException p1) functionForResultNetworkException) async {
    await FunctionViewModel.insertModelToLNDatabaseThereIsParameterFVM(
        mainMethod,
  ...
  @override
  Future<void> setObjectAndMainMethodAndNotifyStream(InsertModelToLNDatabaseThereIsParameterFVM mainMethod, BaseViewModel<BaseModelDomain, BaseListModelDomain<BaseModelDomain>> baseViewModel, BaseModelDomain object, Function functionForResultSuccess, Function(DomainException p1) functionForResultDomainException, Function(LocalException p1) functionForResultLocalException, Function(NetworkException p1) functionForResultNetworkException) async {
    setObject(baseViewModel, object);
    await FunctionViewModel.insertModelToLNDatabaseThereIsParameterFVM(
        mainMethod,
        functionForResultSuccess,
