...
class InsertModelToListModelDomainForLNDatabaseFVUFVM extends BaseFunctionViewUsingFunctionViewModel
    implements ThereIsParameterForMethodsTypeVoidFunctionView<InsertModelToListModelDomainForLNDatabaseFVM,BaseModelDomain>
{
  @override
  void mainMethod(InsertModelToListModelDomainForLNDatabaseFVM mainMethod, Function functionForResultSuccess, Function(DomainException p1) functionForResultDomainException, Function(LocalException p1) functionForResultLocalException, Function(NetworkException p1) functionForResultNetworkException) {
  ...
  @override
  void setObjectAndMainMethod(InsertModelToListModelDomainForLNDatabaseFVM mainMethod, BaseViewModel<BaseModelDomain, BaseListModelDomain<BaseModelDomain>> baseViewModel, BaseModelDomain object, Function functionForResultSuccess, Function(DomainException p1) functionForResultDomainException, Function(LocalException p1) functionForResultLocalException, Function(NetworkException p1) functionForResultNetworkException) {
  ...
  @override
  void setObjectAndMainMethodAndNotifyStream(InsertModelToListModelDomainForLNDatabaseFVM mainMethod, BaseViewModel<BaseModelDomain, BaseListModelDomain<BaseModelDomain>> baseViewModel, BaseModelDomain object, Function functionForResultSuccess, Function(DomainException p1) functionForResultDomainException, Function(LocalException p1) functionForResultLocalException, Function(NetworkException p1) functionForResultNetworkException) {
    setObject(baseViewModel, object);
    FunctionViewModel.insertModelToListModelDomainForLNDatabaseFVM(
        mainMethod,
        functionForResultSuccess,
