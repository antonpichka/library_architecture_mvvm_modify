...
class UpdateListModelToListModelDomainForLocalDatabaseFVUFVM
    extends BaseFVUFVMSpecificallyYesTIPYesNS<UpdateListModelToListModelDomainForLocalDatabaseFVM,List<BaseModelDomain>>
{
  @override
  Future<void> mainMethod(UpdateListModelToListModelDomainForLocalDatabaseFVM mainMethod,
  ...
  async {
    FunctionViewModel.updateListModelToListModelDomainForLocalDatabaseFVM(
      mainMethod,
