...
class GetModelFromNetworkDatabaseThereIsParameterFVUFVMUCNEAndUpdateModelToLocalDatabaseThereIsParameterFVUFVM
    extends BaseFVUFVMUCNESpecificallyNoTIPNoNS<GetModelFromNetworkDatabaseThereIsParameterFVMAndUpdateModelToLocalDatabaseThereIsParameterFVM>
{
  @override
  Future<void> mainMethod(GetModelFromNetworkDatabaseThereIsParameterFVMAndUpdateModelToLocalDatabaseThereIsParameterFVM mainMethod,
  ...
  async {
    await FunctionViewModel.getModelFromNetworkDatabaseThereIsParameterFVMAndUpdateModelToLocalDatabaseThereIsParameterFVM(
        mainMethod,
