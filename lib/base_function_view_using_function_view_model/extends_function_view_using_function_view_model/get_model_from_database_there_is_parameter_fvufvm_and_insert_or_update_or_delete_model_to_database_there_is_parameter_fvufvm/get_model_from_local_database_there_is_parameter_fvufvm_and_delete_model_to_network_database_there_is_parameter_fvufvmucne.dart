...
class GetModelFromLocalDatabaseThereIsParameterFVUFVMAndDeleteModelToNetworkDatabaseThereIsParameterFVUFVMUCNE
    extends BaseFVUFVMUCNESpecificallyNoTIPNoNS<GetModelFromLocalDatabaseThereIsParameterFVMAndDeleteModelToNetworkDatabaseThereIsParameterFVM>
{
  @override
  Future<void> mainMethod(GetModelFromLocalDatabaseThereIsParameterFVMAndDeleteModelToNetworkDatabaseThereIsParameterFVM mainMethod,
  ...
  async {
    await FunctionViewModel.getModelFromLocalDatabaseThereIsParameterFVMAndDeleteModelToNetworkDatabaseThereIsParameterFVM(
        mainMethod,
