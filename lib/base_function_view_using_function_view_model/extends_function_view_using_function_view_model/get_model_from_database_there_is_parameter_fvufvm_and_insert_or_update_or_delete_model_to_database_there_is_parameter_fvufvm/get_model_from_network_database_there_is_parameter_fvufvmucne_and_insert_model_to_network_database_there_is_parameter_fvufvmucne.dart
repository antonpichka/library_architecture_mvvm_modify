...
class GetModelFromNetworkDatabaseThereIsParameterFVUFVMUCNEAndInsertModelToNetworkDatabaseThereIsParameterFVUFVMUCNE
    extends BaseFVUFVMUCNESpecificallyNoTIPNoNS<GetModelFromNetworkDatabaseThereIsParameterFVMAndInsertModelToNetworkDatabaseThereIsParameterFVM>
{
  @override
  Future<void> mainMethod(GetModelFromNetworkDatabaseThereIsParameterFVMAndInsertModelToNetworkDatabaseThereIsParameterFVM mainMethod,
  ...
  async {
    await FunctionViewModel.getModelFromNetworkDatabaseThereIsParameterFVMAndInsertModelToNetworkDatabaseThereIsParameterFVM(
        mainMethod,
