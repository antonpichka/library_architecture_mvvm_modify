...
class GetModelFromLocalDatabaseThereIsParameterFVUFVMAndUpdateModelToNetworkDatabaseThereIsParameterFVUFVMUCNE
    extends BaseFVUFVMUCNESpecificallyNoTIPNoNS<GetModelFromLocalDatabaseThereIsParameterFVMAndUpdateModelToNetworkDatabaseThereIsParameterFVM>
{
  @override
  Future<void> mainMethod(GetModelFromLocalDatabaseThereIsParameterFVMAndUpdateModelToNetworkDatabaseThereIsParameterFVM  mainMethod,
  ...
  async {
    await FunctionViewModel.getModelFromLocalDatabaseThereIsParameterFVMAndUpdateModelToNetworkDatabaseThereIsParameterFVM(
        mainMethod,
