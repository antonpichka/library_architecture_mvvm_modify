...
class GetModelFromNetworkDatabaseThereIsParameterFVUFVMUCNEAndDeleteModelToLocalDatabaseThereIsParameterFVUFVM
    extends BaseFVUFVMUCNESpecificallyNoTIPNoNS<GetModelFromNetworkDatabaseThereIsParameterFVMAndDeleteModelToLocalDatabaseThereIsParameterFVM>
{
  @override
  Future<void> mainMethod(GetModelFromNetworkDatabaseThereIsParameterFVMAndDeleteModelToLocalDatabaseThereIsParameterFVM mainMethod,
  ...
  async {
    await FunctionViewModel.getModelFromNetworkDatabaseThereIsParameterFVMAndDeleteModelToLocalDatabaseThereIsParameterFVM(
        mainMethod,
