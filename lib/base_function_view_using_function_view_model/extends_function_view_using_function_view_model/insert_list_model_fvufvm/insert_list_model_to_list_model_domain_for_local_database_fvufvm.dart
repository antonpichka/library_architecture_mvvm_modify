...
class InsertListModelToListModelDomainForLocalDatabaseFVUFVM
    extends BaseFVUFVMSpecificallyYesTIPYesNS<InsertListModelToListModelDomainForLocalDatabaseFVM,List<BaseModelDomain>>
{
  @override
  Future<void> mainMethod(InsertListModelToListModelDomainForLocalDatabaseFVM mainMethod,
  ...
  async {
    FunctionViewModel.insertListModelToListModelDomainForLocalDatabaseFVM(
        mainMethod,
