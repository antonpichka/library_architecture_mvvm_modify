...
class InsertListModelToListModelDomainForNetworkDatabaseFVUFVM
    extends BaseFVUFVMSpecificallyYesTIPYesNS<InsertListModelToListModelDomainForNetworkDatabaseFVM,List<BaseModelDomain>>
{
  @override
  Future<void> mainMethod(InsertListModelToListModelDomainForNetworkDatabaseFVM mainMethod,
  ...
  async {
    FunctionViewModel.insertListModelToListModelDomainForNetworkDatabaseFVM(
        mainMethod,
