...
class InsertListModelToNetworkDatabaseThereIsParameterFVUFVM
    extends BaseFVUFVMSpecificallyYesTIPYesNS<InsertListModelToNetworkDatabaseThereIsParameterFVM,List<BaseModelDomain>>
{
  @override
  Future<void> mainMethod(InsertListModelToNetworkDatabaseThereIsParameterFVM mainMethod, Function functionForResultSuccess, Function(DomainException p1) functionForResultDomainException, Function(LocalException p1) functionForResultLocalException, Function(NetworkException p1) functionForResultNetworkException) async {
    await FunctionViewModel.insertListModelToNetworkDatabaseThereIsParameterFVM(
        mainMethod,
