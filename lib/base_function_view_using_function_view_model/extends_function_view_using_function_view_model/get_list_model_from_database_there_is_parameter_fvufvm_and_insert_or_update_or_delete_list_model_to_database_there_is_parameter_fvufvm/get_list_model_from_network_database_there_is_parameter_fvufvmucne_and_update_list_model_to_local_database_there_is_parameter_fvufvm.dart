...
class GetListModelFromNetworkDatabaseThereIsParameterFVUFVMUCNEAndUpdateListModelToLocalDatabaseThereIsParameterFVUFVM
    extends BaseFVUFVMUCNESpecificallyNoTIPNoNS<GetListModelFromNetworkDatabaseThereIsParameterFVMAndUpdateListModelToLocalDatabaseThereIsParameterFVM>
{
  @override
  Future<void> mainMethod(GetListModelFromNetworkDatabaseThereIsParameterFVMAndUpdateListModelToLocalDatabaseThereIsParameterFVM mainMethod,
  ...
  async {
    await FunctionViewModel.getListModelFromNetworkDatabaseThereIsParameterFVMAndUpdateListModelToLocalDatabaseThereIsParameterFVM(
        mainMethod,
