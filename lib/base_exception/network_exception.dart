...
class NetworkException extends BaseException {
  ...
  static NetworkException byStatusCode(int statusCode)  {
    return _MapForNetworkException.mapCodeAndNetworkException[statusCode];
  }
...
class _MapForNetworkException {
  static final Map<int,NetworkException> mapCodeAndNetworkException = {
    ...
    204: NetworkException(204,
        '204 No Content',
        'The server has fulfilled the request but does not need to return an entity-body, and might want to return updated metaInformation.'
    ),
    205: NetworkException(205,
        '205 Reset Content',
        'The server has fulfilled the request and the user agent SHOULD reset the document view which caused the request to be sent.'
    ),
    206: NetworkException(206,
      '206 Partial Content',
      'The server has fulfilled the partial GET request for the resource.',
    ),
    300: NetworkException(300,
      '300 Multiple Choices',
      'User (or user agent) can select a preferred representation and redirect its request to that location.',
    ),
    301: NetworkException(301,
      '301 Moved Permanently',
      'The requested resource has been assigned a new permanent URI and any future references to this resource SHOULD use one of the returned URIs.',
    ),
    302: NetworkException(302,
      '302 Found',
      'The requested resource resides temporarily under a different URI.',
    ),
    303: NetworkException(303,
      '303 See Other',
      'The response to the request can be found under a different URI and SHOULD be retrieved using a GET method on that resource.',
    ),
    304: NetworkException(304,
      '304 Not Modified',
      'If the client has performed a conditional GET request and access is allowed, but the document has not been modified, the server SHOULD respond with this status code.',
    ),
    305: NetworkException(305,
        '305 Use Proxy',
        'The requested resource MUST be accessed through the proxy given by the Location field.'
    ),
    307: NetworkException(307,
        '307 Temporary Redirect',
        'The requested resource resides temporarily under a different URI.'
    ),
    400: NetworkException(400,
        '400 Bad Request',
        'The request could not be understood by the server due to malformed syntax.'
    ),
    401: NetworkException(401,
        '401 Unauthorized',
        'The request requires user authentication.'
    ),
    403: NetworkException(403,
        '403 Forbidden',
        'The server understood the request, but is refusing to fulfill it.'
    ),
    404: NetworkException(404,
        '404 Not Found',
        'The server has not found anything matching the Request-URI.'
    ),
    405: NetworkException(405,
        '405 Method Not Allowed',
        'The method specified in the Request-Line is not allowed for the resource identified by the Request-URI.'
    ),
    406: NetworkException(406,
        '406 Not Acceptable',
        'The resource identified by the request is only capable of generating response entities which have content characteristics not acceptable according to the accept headers sent in the request.'
    ),
    407: NetworkException(407,
        '407 Proxy Authentication Required',
        'This code is similar to 401 (Unauthorized), but indicates that the client must first authenticate itself with the proxy.'
    ),
    408: NetworkException(408,
        '408 Request Timeout',
        'The client did not produce a request within the time that the server was prepared to wait.'
    ),
    409: NetworkException(409,
        '409 Conflict',
        'The request could not be completed due to a conflict with the current state of the resource.'
    ),
    410: NetworkException(410,
        '410 Gone',
        'The requested resource is no longer available at the server and no forwarding address is known.'
    ),
    411: NetworkException(411,
        '411 Length Required',
        'The server refuses to accept the request without a defined Content- Length.'
    ),
    412: NetworkException(412,
        '412 Precondition Failed',
        'The precondition given in one or more of the request-header fields evaluated to false when it was tested on the server.'
    ),
    413: NetworkException(413,
        '413 Request Entity Too Large',
        'The server is refusing to process a request because the request entity is larger than the server is willing or able to process.'
    ),
    414: NetworkException(414,
        '414 Request-URI Too Long',
        'The server is refusing to service the request because the Request-URI is longer than the server is willing to interpret.'
    ),
    415: NetworkException(415,
        '415 Unsupported Media Type',
        'The server is refusing to service the request because the entity of the request is in a format not supported by the requested resource for the requested method.'
    ),
    416: NetworkException(416,
    ...
    503: NetworkException(503,
        '503 Service Unavailable',
        'The server is currently unable to handle the request due to a temporary overloading or maintenance of the server.'
    ),
    504: NetworkException(504,
        '504 Gateway Timeout',
