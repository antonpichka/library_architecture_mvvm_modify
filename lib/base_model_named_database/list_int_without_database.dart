...
class ListIntWithoutDatabase
    extends BaseListModelNamedDatabase<IntWithoutDatabase>
{
  ListIntWithoutDatabase(List<IntWithoutDatabase> listIntWithoutDatabase) : super(listIntWithoutDatabase);
}