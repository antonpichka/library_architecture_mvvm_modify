...
class ListIntWithoutLibrary
    extends BaseListModelNamed<IntWithoutLibrary>
{
  ListIntWithoutLibrary(List<IntWithoutLibrary> listIntWithoutDatabase) : super(listIntWithoutDatabase);
}