...
class BoolWithoutDatabase
    extends BaseModelNamedDatabase
{
  bool isField;

  BoolWithoutDatabase(this.isField) : super(isField.toString());

  static BoolWithoutDatabase get getBoolWithoutDatabase => BoolWithoutDatabase(false);
