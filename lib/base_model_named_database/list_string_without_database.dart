...
class ListStringWithoutDatabase
    extends BaseListModelNamedDatabase<StringWithoutDatabase>
{
  ListStringWithoutDatabase(List<StringWithoutDatabase> listStringWithoutDatabase) : super(listStringWithoutDatabase);
}