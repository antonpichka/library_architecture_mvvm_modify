...
class ListBoolWithoutLibrary
    extends BaseListModelNamed<BoolWithoutLibrary>
{
  ListBoolWithoutLibrary(List<BoolWithoutLibrary> listBoolWithoutDatabase) : super(listBoolWithoutDatabase);
}