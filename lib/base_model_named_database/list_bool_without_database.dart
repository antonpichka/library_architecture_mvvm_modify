...
class ListBoolWithoutDatabase
    extends BaseListModelNamedDatabase<BoolWithoutDatabase>
{
  ListBoolWithoutDatabase(List<BoolWithoutDatabase> listBoolWithoutDatabase) : super(listBoolWithoutDatabase);
}