...
abstract class UpdateModelToLNDatabaseThereIsParameterUsedProviderBaseModelDomainCBFVM<T extends BaseModelDomain>
    implements ProviderBaseModelDomainCBFVM<T>, AbilityToClone<UpdateModelToLNDatabaseThereIsParameterUsedProviderBaseModelDomainCBFVM>
{
  ResponseGenericBoolAndDomainException updateModelToLNDatabaseThereIsParameterCBFVM(List<BaseModelDomain> list);
}