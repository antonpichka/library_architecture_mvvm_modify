...
import 'package:library_architecture_mvvm_modify/base_model_named_database/list_bool_without_database.dart';
...
abstract class BoolWithoutDatabaseViewModel<T extends Enum>
    extends BaseViewModel<BoolWithoutDatabase,ListBoolWithoutDatabase,T>
{
  BoolWithoutDatabaseViewModel(
      ...
      listEnumBaseModelNamedDatabaseAndBaseListModelNamedDatabaseVM,
          () => SCModel(iStreams,BoolWithoutDatabase.getBoolWithoutDatabase,ListBoolWithoutDatabase([])));

  @override
  @nonVirtual
  BoolWithoutDatabase cloneModelNamedDatabase(
      BoolWithoutDatabase modelNamedDatabase)
  {
    return BoolWithoutDatabase(modelNamedDatabase.isField);
  }
}