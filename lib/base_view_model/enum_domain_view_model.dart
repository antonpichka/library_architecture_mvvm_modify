...
class EnumDomainViewModel<T extends Enum,U extends BaseTypeParameter> extends BaseViewModel<EnumDomain,ListEnumDomain,Default<EnumDomain>,ListDefault<ListEnumDomain,Default<EnumDomain>>,T,U> {
  EnumDomainViewModel(
