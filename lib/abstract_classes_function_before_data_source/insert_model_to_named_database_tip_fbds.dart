...
abstract class InsertModelToNamedDatabaseTIPFBDS<T extends BaseModelNamedDatabase,Y extends BaseTypeParameter>
{
  InsertModelToNamedDatabaseTIPFBDS();

  ResponseGenericBoolAndLocalExceptionAndCancelOWEAndS insertModelToNamedDatabaseTIP(
