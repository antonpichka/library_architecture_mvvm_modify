...
abstract class UpdateListModelToNamedTIPFBDS<T extends BaseListModelNamed,Y extends BaseTypeParameter>
{
  UpdateListModelToNamedTIPFBDS();

  ResponseGenericBoolAndLocalExceptionAndCancelOWEAndS updateListModelToNamedTIP(
      T listModelNamed,
