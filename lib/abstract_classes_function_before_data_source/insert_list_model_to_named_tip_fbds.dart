...
abstract class InsertListModelToNamedTIPFBDS<T extends BaseListModelNamed,Y extends BaseTypeParameter>
{
  InsertListModelToNamedTIPFBDS();

  ResponseGenericBoolAndLocalExceptionAndCancelOWEAndS insertListModelToNamedTIP(
      T listModelNamed,
