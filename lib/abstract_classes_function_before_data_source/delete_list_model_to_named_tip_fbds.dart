...
abstract class DeleteListModelToNamedTIPFBDS<T extends BaseListModelNamed,Y extends BaseTypeParameter>
{
  DeleteListModelToNamedTIPFBDS();

  ResponseGenericBoolAndLocalExceptionAndCancelOWEAndS deleteListModelToNamedTIP(
