...
abstract class UpdateModelToNamedTIPFBDS<T extends BaseModelNamed,Y extends BaseTypeParameter>
{
  UpdateModelToNamedTIPFBDS();

  ResponseGenericBoolAndLocalExceptionAndCancelOWEAndS updateModelToNamedTIP(
      T modelNamed,
