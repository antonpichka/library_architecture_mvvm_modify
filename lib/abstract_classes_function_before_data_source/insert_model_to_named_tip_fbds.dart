...
abstract class InsertModelToNamedTIPFBDS<T extends BaseModelNamed,Y extends BaseTypeParameter>
{
  InsertModelToNamedTIPFBDS();

  ResponseGenericBoolAndLocalExceptionAndCancelOWEAndS insertModelToNamedTIP(
      T modelNamed,
