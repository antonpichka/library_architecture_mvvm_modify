...
abstract class DeleteModelToNamedTIPFBDS<T extends BaseModelNamed,Y extends BaseTypeParameter>
{
  DeleteModelToNamedTIPFBDS();

  ResponseGenericBoolAndLocalExceptionAndCancelOWEAndS deleteModelToNamedTIP(
