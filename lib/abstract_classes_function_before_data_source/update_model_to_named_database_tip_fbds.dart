...
abstract class UpdateModelToNamedDatabaseTIPFBDS<T extends BaseModelNamedDatabase,Y extends BaseTypeParameter>
{
  UpdateModelToNamedDatabaseTIPFBDS();

  ResponseGenericBoolAndLocalExceptionAndCancelOWEAndS updateModelToNamedDatabaseTIP(
