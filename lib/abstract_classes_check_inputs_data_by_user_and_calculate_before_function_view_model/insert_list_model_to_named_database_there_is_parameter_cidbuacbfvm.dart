...
///   }
///
abstract class InsertListModelToNamedDatabaseThereIsParameterCIDBUACBFVM<T extends BaseModelDomain,Y extends BaseListModelDomain>
{
  InsertListModelToNamedDatabaseThereIsParameterCIDBUACBFVM();

  ResponseGenericBoolAndDomainException insertListModelToNamedDatabaseThereIsParameterCIDBUACBFVM(Y listModelDomain, List<T> list);
}